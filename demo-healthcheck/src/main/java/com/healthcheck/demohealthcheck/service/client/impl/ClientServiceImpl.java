...
public class ClientServiceImpl implements ClientService{
    ...
    @Override
    public Optional<Client> updateByUsername(String username, Client newClient) {
    ...
    @Override
    public Optional<Client> patchUsernameByEmail(String email, String username) {
        return ClientDatabase.patchUsernameByEmail(email, username);
    }

    @Override
    public Optional<Client> patchPasswordByEmail(String email, String password) {
        return ClientDatabase.patchPasswordByEmail(email, password);
    }

    @Override
    public Optional<Client> patchFirstnameByEmail(String email, String firstname) {
        return ClientDatabase.patchFirstnameByEmail(email, firstname);
    }

    @Override
    public Optional<Client> patchLastnameByEmail(String email, String lastname) {
        return ClientDatabase.patchLastnameByEmail(email, lastname);
    }

    @Override
    public Optional<Client> patchEmailByUsername(String username, String email) {
        return ClientDatabase.patchEmailByUsername(username, email);
    }

    @Override
    public Optional<Client> patchPasswordByUsername(String username, String password) {
        return ClientDatabase.patchPasswordByUsername(username, password);
    }

    @Override
    public Optional<Client> patchFirstnameByUsername(String username, String firstname) {
        return ClientDatabase.patchFirstnameByUsername(username, firstname);
    }

    @Override
    public Optional<Client> patchLastnameByUsername(String username, String lastname) {
     ...
     */
     ...
     @Override
     public Optional<Client> patchBMByUsername(String username, BodyMeasurement bodyMeasurement){
      ...
      */
      ...
      @Override
      public Optional<Client> patchVSByUsername(String username, VitalSigns vitalSigns) {
